...
func (c2d C2D) SetCanvas(val js.Value) {
...
func (c2d C2D) SetFillStyle(val js.Value) {
...
func (c2d C2D) SetStrokeStyle(val js.Value) {
...
func (c2d C2D) DrawImage(image js.Value, dx, dy float64) {
...
func (c2d C2D) Clip(fillRule CanvasFillRule) {
	js.Value(c2d).Call("clip", fillRule)
}

func (c2d C2D) Fill(fillRule CanvasFillRule) {
	js.Value(c2d).Call("fill", fillRule)
}

func (c2d C2D) IsPointInPath(x, y float64, fillRule CanvasFillRule) js.Value {
	return js.Value(c2d).Call("isPointInPath", x, y, fillRule)
}

func (c2d C2D) IsPointInStroke(x, y float64) js.Value {
...
func (c2d C2D) CreatePattern(image js.Value, repetition string) js.Value {
...
func (c2d C2D) CreateImageData(sw, sh float64, settings js.Value) js.Value {
	return js.Value(c2d).Call("createImageData", sw, sh, settings)
}

func (c2d C2D) GetImageData(sx, sy, sw, sh float64, settings js.Value) js.Value {
	return js.Value(c2d).Call("getImageData", sx, sy, sw, sh, settings)
}

func (c2d C2D) PutImageData(imagedata js.Value, dx, dy float64) {
	js.Value(c2d).Call("putImageData", imagedata, dx, dy)
}

func (c2d C2D) Arc(x, y, radius, startAngle, endAngle float64, counterclockwise bool) {
...
func (c2d C2D) Ellipse(x, y, radiusX, radiusY, rotation, startAngle, endAngle float64, counterclockwise bool) {
...
func (c2d C2D) RoundRect(x, y, w, h float64, radii js.Value) {
...
func (c2d C2D) SetLineDash(segments js.Value) {
...
func (c2d C2D) FillText(text string, x, y, maxWidth float64) {
...
func (c2d C2D) StrokeText(text string, x, y, maxWidth float64) {
...
func (c2d C2D) SetTransform(a, b, c, d, e, f float64) {
...
func (c2d C2D) DrawFocusIfNeeded(element js.Value) {
