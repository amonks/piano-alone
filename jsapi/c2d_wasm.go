...
func (c2d C2D) DrawImage3(image any, dx, dy float64) js.Value {
	return js.Value(c2d).Call("drawImage", image, dx, dy)
}

func (c2d C2D) DrawImage5(image any, dx, dy, dw, dh float64) js.Value {
	return js.Value(c2d).Call("drawImage", image, dx, dy, dw, dh)
}

func (c2d C2D) DrawImage9(image any, sx, sy, sw, sh, dx, dy, dw, dh float64) js.Value {
	return js.Value(c2d).Call("drawImage", image, sx, sy, sw, sh, dx, dy, dw, dh)
}

func (c2d C2D) BeginPath() js.Value {
	return js.Value(c2d).Call("beginPath")
}

func (c2d C2D) Clip0() js.Value {
	return js.Value(c2d).Call("clip")
}

func (c2d C2D) Clip1CanvasFillRule(fillRule CanvasFillRule) js.Value {
	return js.Value(c2d).Call("clip", fillRule)
}

func (c2d C2D) Clip1Path2D(path any) js.Value {
	return js.Value(c2d).Call("clip", path)
}

func (c2d C2D) Clip2(path any, fillRule CanvasFillRule) js.Value {
	return js.Value(c2d).Call("clip", path, fillRule)
}

func (c2d C2D) Fill0() js.Value {
	return js.Value(c2d).Call("fill")
}

func (c2d C2D) Fill1CanvasFillRule(fillRule CanvasFillRule) js.Value {
	return js.Value(c2d).Call("fill", fillRule)
}

func (c2d C2D) Fill1Path2D(path any) js.Value {
	return js.Value(c2d).Call("fill", path)
}

func (c2d C2D) Fill2(path any, fillRule CanvasFillRule) js.Value {
	return js.Value(c2d).Call("fill", path, fillRule)
}
...
func (c2d C2D) Stroke0() js.Value {
	return js.Value(c2d).Call("stroke")
}

func (c2d C2D) Stroke1(path any) js.Value {
	return js.Value(c2d).Call("stroke", path)
}
...
func (c2d C2D) PutImageData3(imagedata any, dx, dy float64) js.Value {
	return js.Value(c2d).Call("putImageData", imagedata, dx, dy)
}

func (c2d C2D) PutImageData7(imagedata any, dx, dy, dirtyX, dirtyY, dirtyWidth, dirtyHeight float64) js.Value {
	return js.Value(c2d).Call("putImageData", imagedata, dx, dy, dirtyX, dirtyY, dirtyWidth, dirtyHeight)
}

func (c2d C2D) Arc5(x, y, radius, startAngle, endAngle float64) js.Value {
	return js.Value(c2d).Call("arc", x, y, radius, startAngle, endAngle)
}

func (c2d C2D) Arc6(x, y, radius, startAngle, endAngle float64, counterclockwise bool) js.Value {
	return js.Value(c2d).Call("arc", x, y, radius, startAngle, endAngle, counterclockwise)
}

func (c2d C2D) ArcTo(x1, y1, x2, y2, radius float64) js.Value {
	return js.Value(c2d).Call("arcTo", x1, y1, x2, y2, radius)
}

func (c2d C2D) BezierCurveTo(cp1x, cp1y, cp2x, cp2y, x, y float64) js.Value {
	return js.Value(c2d).Call("bezierCurveTo", cp1x, cp1y, cp2x, cp2y, x, y)
}

func (c2d C2D) ClosePath() js.Value {
	return js.Value(c2d).Call("closePath")
}

func (c2d C2D) Ellipse7(x, y, radiusX, radiusY, rotation, startAngle, endAngle float64) js.Value {
	return js.Value(c2d).Call("ellipse", x, y, radiusX, radiusY, rotation, startAngle, endAngle)
}

func (c2d C2D) Ellipse8(x, y, radiusX, radiusY, rotation, startAngle, endAngle float64, counterclockwise bool) js.Value {
	return js.Value(c2d).Call("ellipse", x, y, radiusX, radiusY, rotation, startAngle, endAngle, counterclockwise)
}

func (c2d C2D) LineTo(x, y float64) js.Value {
	return js.Value(c2d).Call("lineTo", x, y)
}

func (c2d C2D) MoveTo(x, y float64) js.Value {
	return js.Value(c2d).Call("moveTo", x, y)
}

func (c2d C2D) QuadraticCurveTo(cpx, cpy, x, y float64) js.Value {
	return js.Value(c2d).Call("quadraticCurveTo", cpx, cpy, x, y)
}

func (c2d C2D) Rect(x, y, w, h float64) js.Value {
	return js.Value(c2d).Call("rect", x, y, w, h)
}

func (c2d C2D) RoundRect4(x, y, w, h float64) js.Value {
	return js.Value(c2d).Call("roundRect", x, y, w, h)
}

func (c2d C2D) RoundRect5(x, y, w, h, radii float64) js.Value {
	return js.Value(c2d).Call("roundRect", x, y, w, h, radii)
}
...
func (c2d C2D) SetLineDash(segments any) js.Value {
	return js.Value(c2d).Call("setLineDash", segments)
}

func (c2d C2D) ClearRect(x, y, w, h float64) js.Value {
	return js.Value(c2d).Call("clearRect", x, y, w, h)
}

func (c2d C2D) FillRect(x, y, w, h float64) js.Value {
	return js.Value(c2d).Call("fillRect", x, y, w, h)
}

func (c2d C2D) StrokeRect(x, y, w, h float64) js.Value {
	return js.Value(c2d).Call("strokeRect", x, y, w, h)
}

func (c2d C2D) Reset() js.Value {
	return js.Value(c2d).Call("reset")
}

func (c2d C2D) Restore() js.Value {
	return js.Value(c2d).Call("restore")
}

func (c2d C2D) Save() js.Value {
	return js.Value(c2d).Call("save")
}

func (c2d C2D) FillText3(text string, x, y float64) js.Value {
	return js.Value(c2d).Call("fillText", text, x, y)
}

func (c2d C2D) FillText4(text string, x, y, maxWidth float64) js.Value {
	return js.Value(c2d).Call("fillText", text, x, y, maxWidth)
}
...
func (c2d C2D) StrokeText3(text string, x, y float64) js.Value {
	return js.Value(c2d).Call("strokeText", text, x, y)
}

func (c2d C2D) StrokeText4(text string, x, y, maxWidth float64) js.Value {
	return js.Value(c2d).Call("strokeText", text, x, y, maxWidth)
}
...
func (c2d C2D) ResetTransform() js.Value {
	return js.Value(c2d).Call("resetTransform")
}

func (c2d C2D) Rotate(angle float64) js.Value {
	return js.Value(c2d).Call("rotate", angle)
}

func (c2d C2D) Scale(x, y float64) js.Value {
	return js.Value(c2d).Call("scale", x, y)
}

func (c2d C2D) SetTransform0() js.Value {
	return js.Value(c2d).Call("setTransform")
}

func (c2d C2D) SetTransform1(transform any) js.Value {
	return js.Value(c2d).Call("setTransform", transform)
}

func (c2d C2D) SetTransform6(a, b, c, d, e, f float64) js.Value {
	return js.Value(c2d).Call("setTransform", a, b, c, d, e, f)
}

func (c2d C2D) Transform(a, b, c, d, e, f float64) js.Value {
	return js.Value(c2d).Call("transform", a, b, c, d, e, f)
}

func (c2d C2D) Translate(x, y float64) js.Value {
	return js.Value(c2d).Call("translate", x, y)
}

func (c2d C2D) DrawFocusIfNeeded1(element any) js.Value {
	return js.Value(c2d).Call("drawFocusIfNeeded", element)
}

func (c2d C2D) DrawFocusIfNeeded2(path any, element any) js.Value {
	return js.Value(c2d).Call("drawFocusIfNeeded", path, element)
}
